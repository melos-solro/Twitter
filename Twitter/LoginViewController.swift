...
class LoginViewController: UIViewController {
    ...
    @IBAction func onLoginButton(sender: AnyObject) {
        let twitterClient = BDBOAuth1SessionManager(baseURL: NSURL(string: "https://api.twitter.com"), consumerKey: "gxecWzOxuT85NmRVRKCAhqJdX", consumerSecret: "CAYWZliiPke2mWFYzlTdojdxw62R52W6eATxWxJSVzSvJ8Jk8r")
